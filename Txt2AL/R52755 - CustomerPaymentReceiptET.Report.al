report 52755 "Customer - Payment Receipt ET"
{
    DefaultLayout = RDLC;
    RDLCLayout = './CustomerPaymentReceiptET.rdlc';
    ...
    dataset
    {
        dataitem("Cust. Ledger Entry"; "Cust. Ledger Entry")
        {
            ...
            dataitem(PageLoop; "Integer")
            {
                ...
                column(VATRegistrationNo_Customer; Cust."VAT Registration No.")
                {
                }
                column(OriginalTxt; CopyText)
                {
                }
                column(ReceiptTxt; Text50001)
                {
                }
            ...
            begin
                ...
                // JD_PMR_260308_sn Se for um adiantamento não começamos com este valor
                CalcFields("Remaining Amount");
                if ("Document Type" = "Document Type"::Payment) and (Open = true) and ("Remaining Amount" <> 0) then
                    RemainingAmount := 0
                else
                    // JD_PMR_260308_en
    ...
    {
        NumberLbl = 'Number';
        EmisDateLbl = 'Emission Date';
        EntityNoLbl = 'Entity No.';
        SedeLbl = '';
        AddressFooterLbl = '';
        AddressFooter2Lbl = '';
        AddressFooter3Lbl = '';
        SocialCapitalFooterLbl = '';
        RegComercialLbl = '';
        ProcessedComputerLbl = 'Processado por Computador';
    }
