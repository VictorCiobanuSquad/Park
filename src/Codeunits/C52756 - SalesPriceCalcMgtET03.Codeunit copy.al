// codeunit 80000 "Sales Price Calc. Mgt.80000"
// {
...
//     var
//         BestPrice: Record "Price List Line";
//     begin
...
//                     case true of
//                         ((BestPrice."Currency Code" = '') and (BestPrice."Currency Code" <> '')) or
//                       ((BestPrice."Variant Code" = '') and (BestPrice."Variant Code" <> '')):
//                             BestPrice := PriceListLine;
//                         ((BestPrice."Currency Code" = '') or (BestPrice."Currency Code" <> '')) and
//                       ((BestPrice."Variant Code" = '') or (BestPrice."Variant Code" <> '')):
//                             if (BestPrice."Unit Price" = 0) or
//                                (CalcLineAmount(BestPrice) > CalcLineAmount(PriceListLine))
//                             then
//                                 BestPrice := PriceListLine;
//                     end;
//                 end;
...
//         if BestPrice."Unit Price" = 0 then begin
//             ConvertPriceToVAT(
...
//             Clear(BestPrice);
//             BestPrice."Unit Price" := Item."Unit Price";
//             BestPrice."Allow Line Disc." := AllowLineDisc;
//             BestPrice."Allow Invoice Disc." := AllowInvDisc;
//         end;

//         PriceListLine := BestPrice;
//     end;
...
//         FromSalesPrice.SetRange("Price List Code");
//         //TODO: 
...
//                 repeat
//                     FromSalesPrice.SetRange("Price List Code", TempTargetCampaignGr."Campaign No.");
//                     CopySalesPriceToSalesPrice(FromSalesPrice, ToSalesPrice);
...
//      
//     procedure CopySalesPrice(var SalesPrice: Record "Price List Line")
//     begin
//         SalesPrice.DeleteAll;
//         CopySalesPriceToSalesPrice(TempSalesPrice, SalesPrice);
//     end;

//     local procedure CopySalesPriceToSalesPrice(var FromSalesPrice: Record "Price List Line"; var ToSalesPrice: Record "Price List Line")
//     begin
...
//         ResPrice.Init;
//         //"Job No." := JobNo;
//         ResPrice."Price List Code" := Code2;
...
//     local procedure CalcLineAmount(SalesPrice: Record "Price List Line"): Decimal
//     begin
